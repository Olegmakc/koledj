...
$kod_specialty = $_POST['kod_specialty']; $name_specialty = $_POST['name_specialty'];

$sql = "INSERT INTO specialty (kod_specialty, name_specialty) VALUES ('$kod_specialty', '$name_specialty' )";
